...
export default function Dashboard({ data = {}, onLogout = () => {} }) {
  ...
  // Sync when user.house changes in AuthContext
  useEffect(() => {
  ...
  const handleActionClick = (label) => setActiveAction(label);
  const handleGoBack = () => setActiveAction(null);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <div className="flex flex-1 justify-center">
        {/* Centered main content with side gaps */}
        <main className="w-full max-w-6xl p-6 space-y-6 overflow-auto">
