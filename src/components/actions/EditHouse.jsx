      ...
      <CardContent>
        ...
        {loading ? null : (
          <div className="space-y-4">
            <div className="bg-muted rounded-lg p-3 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                {uploading ? (
                  ...
                  <div className="mt-4 flex flex-col sm:flex-row justify-center gap-2.5">
                    <button
                      ...
                      disabled={busy}
                      className="inline-flex items-center justify-center gap-1.5 rounded-full bg-primary px-5 py-2 min-h-[44px] text-sm font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      onClick={clearStaged}
                      disabled={busy}
                      className="inline-flex items-center justify-center gap-1.5 rounded-full border border-border px-5 py-2 min-h-[44px] text-sm font-semibold text-muted-foreground hover:bg-muted disabled:opacity-50"
                    >
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  <button
                    ...
                    className="rounded-md min-h-[44px] px-4 py-2 bg-secondary text-xs font-semibold text-secondary-foreground hover:bg-secondary/80 disabled:opacity-50"
                  >
                    Replace
                  </button>
                  <button
                    ...
                    onClick={removeLogo}
                    disabled={busy}
                    className="flex items-center justify-center gap-1 rounded-md border border-accent-red/30 min-h-[44px] px-4 py-2 text-xs font-semibold text-accent-red hover:bg-accent-red/10 disabled:opacity-50"
                  >
