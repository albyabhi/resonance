...
export default function EventTimeline({ eventId }) {
  ...
  if (loading) {
    return <div className="text-sm text-muted-foreground py-2">Loading timeline...</div>;
  }
  ...
  if (!timeline.length) {
    return <div className="text-sm text-muted-foreground py-2">No status changes recorded.</div>;
  }
