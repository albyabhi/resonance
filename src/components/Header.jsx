      ...
      <div className="mx-auto flex h-full w-full max-w-[1600px] items-center justify-between gap-4 px-4 sm:px-6">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <button type="button" onClick={() => navigate("/dashboard")} className="flex min-w-0 items-center gap-3 cursor-pointer">
            <img src={Logo} alt="Resonance" className="h-9 w-9 rounded-lg object-cover" />
            <span className="hidden text-lg font-semibold tracking-tight sm:inline" style={{ color: "var(--foreground)" }}>
