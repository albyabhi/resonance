...
export const ERROR_MESSAGES = {
  ...
  "already registered for this event": "This entry is already registered for this event.",
  "cannot edit": "This entry can no longer be edited — contact the organizer.",
  "Individual entries support revoke only": "Individual entries support revoke only — use Revoke to withdraw.",
  "does not belong to this entry's group": "Selected participant does not belong to this entry's group.",
  "Scoring has started for this entry": "Scoring has started for this entry — it is now locked.",
  "Results exist for this entry": "Results exist for this entry — it is now locked.",
  "An active appeal exists for this entry": "An active appeal exists for this entry — it is locked until resolved.",
  "Chest numbers already assigned": "Chest numbers are already assigned — contact the organizer to withdraw.",
  "You can only manage teams in your assigned events": "You can only manage entries in your assigned events.",
  ...
  "does not belong to your organization": "This event belongs to a different competition or organization. Switch competition or log out and back in, then retry.",
  "belongs to a different competition": "This event belongs to a different competition. Switch competition to register.",
